...
public class EconomicsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        economicsRef.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        addApp.setOnClickListener(view -> {
            startActivity(new Intent(EconomicsActivity.this, AddApplicationActivity.class));
        });
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(EconomicsActivity.this, CategoriesActivity.class));
            }
        });
