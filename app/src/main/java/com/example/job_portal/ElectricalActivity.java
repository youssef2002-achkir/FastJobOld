...
public class ElectricalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        electricalRef.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        addApp.setOnClickListener(view -> {
            startActivity(new Intent(ElectricalActivity.this, AddApplicationActivity.class));
        });
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ElectricalActivity.this, CategoriesActivity.class));
            }
        });
    }
}